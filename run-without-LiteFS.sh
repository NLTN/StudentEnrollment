...
# Start the services
foreman start -m gateway=1,enrollment_service=3,user_service=1,dynamodb=1,redis=1,notification_service=1,webhook=1,webhook_dispatcher=1,mail_dispatcher=1